...
pub const CreatePhysFrameIterator = frame.CreatePhysFrameIterator;
...
pub const CreatePhysFrameRange = frame.CreatePhysFrameRange;
...
pub const CreatePhysFrameRangeInclusive = frame.CreatePhysFrameRangeInclusive;
...
pub const CreatePageRange = page.CreatePageRange;
...
pub const CreatePageRangeInclusive = page.CreatePageRangeInclusive;
...
pub const CreatePageIterator = page.CreatePageIterator;
