...
pub const InterruptDescriptorTable = extern struct {
    ...
    vmm_communication_exception: HandlerWithErrorCodeFuncEntry,
    ...
    pub fn init() InterruptDescriptorTable {
        return .{
            ...
            .reserved_2 = [_]HandlerFuncEntry{HandlerFuncEntry.missing()} ** 8,
            .vmm_communication_exception = HandlerWithErrorCodeFuncEntry.missing(),
