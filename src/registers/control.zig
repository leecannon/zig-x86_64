...
pub const Cr0 = struct {
    ...
    pub fn isPROTECTED_MODE_ENABLE(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isMONITOR_COPROCESSOR(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isEMULATE_COPROCESSOR(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isTASK_SWITCHED(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isNUMERIC_ERROR(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isWRITE_PROTECT(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isALIGNMENT_MASK(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isNOT_WRITE_THROUGH(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isCACHE_DISABLE(self: Cr0) callconv(.Inline) bool {
    ...
    pub fn isPAGING(self: Cr0) callconv(.Inline) bool {
...
pub const Cr3Flags = struct {
    ...
    pub fn empty() callconv(.Inline) Cr3Flags {
        return .{ .value = 0 };
    }
    ...
    pub fn isPAGE_LEVEL_WRITETHROUGH(self: Cr3Flags) callconv(.Inline) bool {
    ...
    pub fn isPAGE_LEVEL_CACHE_DISABLE(self: Cr3Flags) callconv(.Inline) bool {
...
pub const Cr4 = struct {
    ...
    pub fn isVIRTUAL_8086_MODE_EXTENSIONS(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPROTECTED_MODE_VIRTUAL_INTERRUPTS(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isTIMESTAMP_DISABLE(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isDEBUGGING_EXTENSIONS(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPAGE_SIZE_EXTENSION(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPHYSICAL_ADDRESS_EXTENSION(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isMACHINE_CHECK_EXCEPTION(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPAGE_GLOBAL(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPERFORMANCE_MONITOR_COUNTER(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isOSFXSR(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isOSXMMEXCPT_ENABLE(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isUSER_MODE_INSTRUCTION_PREVENTION(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isL5_PAGING(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isVIRTUAL_MACHINE_EXTENSIONS(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isSAFER_MODE_EXTENSIONS(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isFSGSBASE(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPCID(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isOSXSAVE(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isSUPERVISOR_MODE_EXECUTION_PROTECTION(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isSUPERVISOR_MODE_ACCESS_PREVENTION(self: Cr4) callconv(.Inline) bool {
    ...
    pub fn isPROTECTION_KEY(self: Cr4) callconv(.Inline) bool {
